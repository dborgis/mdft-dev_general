...
contains
    ...
    subroutine init
        ...
        cgb%A3 = getinput%dp('cgb_A3', defaultvalue=0._dp)
        cgb%A4 = getinput%dp('cgb_A4', defaultvalue=0._dp)
...
!        endif
    ...
    subroutine coarse_grained_bridge(fb, df)
        ...
        integer :: is, ix, iy, iz
        integer :: ns, nx, ny, nz
        real(dp) :: dv, kT,n0, Phib, A3, A4, sigma
            ...
            do iy=1,ny
              do ix=1,nx
                ...
                deltaN_cg = density_cg(ix,iy,iz) - one
                     ...
                     Phib = A3 * deltaN_cg**3 + A4 * deltaN_cg**4
                     dfb_cg(ix,iy,iz) = kT*(3.0_dp*A3*deltaN_cg**2+ 4.0_dp*A4*deltaN_cg**3)
