...
!Get the order of the main symmetry axis of the solvent
sym_order=input_int('sym_order')

!Read the number of spatial grid nodes
nfft1=input_int('nfft1')
nfft2=input_int('nfft2')
nfft3=input_int('nfft3')

! look for temperature in input
temp=input_dp('temperature')
