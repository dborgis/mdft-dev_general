SUBROUTINE energy_polarization_multi_with_nccoupling(F_pol)
    ...
    USE system,          ONLY: spaceGrid, thermocond, n_0, nb_species, &
...
!===================================================================================================================================
    ...
    BLOCK
        ...
        DO CONCURRENT (i=1:nfft1/2+1, j=1:nfft2, k=1:nfft3, s=1:nb_species)
            ...
            F_pol_tot_k =F_pol_tot_k-(thermocond%kbT*3/(2*mu_SPCE**2*n_0)*deltaVk*facsym/(twopi**3)*solvent(s)%rho0**2*&
        ...
        !!========================================================================================================================
                ...
                dF_pol_tot_k_tmp =-thermocond%kbT*3.0_dp*solvent(s)%rho0/(mu_SPCE**2*n_0)*molRotGrid%weight(p)*&
