...
use system , only : nfft1 , nfft2 , nfft3 , x_solv  ,y_solv , z_solv , chg_solv , id_solv , nb_omega , nb_psi , &
 nb_solvent_sites, &
...
allocate (x_charge ( nb_of_interpolation , nb_psi , nb_omega ) )
allocate (y_charge (nb_of_interpolation , nb_psi , nb_omega ) )
allocate (z_charge (nb_of_interpolation , nb_psi , nb_omega ) )
allocate (q_charge (nb_of_interpolation , nb_psi , nb_omega ) )
x_charge=0
y_charge=0
z_charge=0
q_charge=0.0_dp
allocate ( xmod ( nb_solvent_sites  , nb_psi , nb_omega) )
allocate ( ymod ( nb_solvent_sites  , nb_psi , nb_omega) )
allocate ( zmod ( nb_solvent_sites  , nb_psi , nb_omega) )
xmod=0.0_dp
ymod=0.0_dp
zmod=0.0_dp
