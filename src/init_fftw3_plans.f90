...
!COPY OF /USR/INCLUDE/FFTW3.F ! SHOULD BE REMOVED VERY FAST
    INTEGER FFTW_R2HC
    ...
    ALLOCATE ( in_forward   ( nfft(1)      , nfft(2) , nfft(3) ) )
    ALLOCATE ( out_forward  ( nfft(1)/2 +1 , nfft(2) , nfft(3) ) )
    ALLOCATE ( out_backward ( nfft(1)      , nfft(2) , nfft(3) ) )
    ALLOCATE ( in_backward  ( nfft(1)/2 +1 , nfft(2) , nfft(3) ) )
    ! prepare plans needed by fftw3
    CALL dfftw_plan_dft_r2c_3d ( plan_forward  , nfft(1) , nfft(2) , nfft(3) , in_forward , out_forward , FFTW_MEASURE )
    CALL dfftw_plan_dft_c2r_3d ( plan_backward , nfft(1) , nfft(2) , nfft(3) , in_backward , out_backward , FFTW_MEASURE )
